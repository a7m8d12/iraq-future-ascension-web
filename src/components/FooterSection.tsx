...
const FooterSection: React.FC = () => {
  ...
  return (
    <footer className="bg-black bg-opacity-60 backdrop-blur-md border-t border-iraq-green-dark py-12 text-iraq-gray">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 pt-6 border-t border-iraq-green-dark/30 text-sm text-center">
