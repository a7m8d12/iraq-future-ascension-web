...
const HeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center items-center pt-32 pb-32">
      {/* Glowing circles */}
      ...
      <div className="container mx-auto px-4 text-center z-10">
        <h1 
          ref={titleRef}
          className="text-5xl md:text-7xl lg:text-8xl font-bold mb-3 tracking-tight"
          style={{ transform: 'translateY(20px)' }}
        >
          <span className="text-iraq-green glow-text">GET FUNDED</span>
        </h1>
        
        <p 
          ref={subtitleRef}
          className="text-xl md:text-2xl lg:text-3xl mb-3 font-bold text-white"
          style={{ transform: 'translateY(20px)' }}
        >
